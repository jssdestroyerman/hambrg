...
<div
	class="absolute top-0 left-[-50px] right-[-50px] bottom-0 bg-[#191919] z-10 -translate-y-[100%] rotate-12 styleMenu1"
/>
<div
	class="absolute top-0 left-[-50px] right-[-50px] bottom-0 bg-[#cd2d22] z-10 flex justify-center items-center -translate-y-[100%] rotate-12 styleMenu2 "
>
